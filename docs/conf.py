#
# shapelink documentation build configuration file, created by
...
rst_prolog = """
:github_url: https://github.com/ZELLMECHANIK-DRESDEN/shapelink
"""
...
# html_logo = "logo/shapelink_large_white.png"
# html_theme_options = {
#     'logo_only': True,
# }
...
htmlhelp_basename = 'shapelinkdoc'
...
latex_documents = [
    (master_doc, 'shapelink.tex', 'Shape-Link Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'shapelink', 'Shape-Link Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'shapelink', 'Shape-Link Documentation',
     author, 'shapelink', 'Inter-process communication with Shape-In',
     'Scientific'),
]
